...
// end
	...
	if (pm->waterlevel == 3) {
		if ( // L0 - Was thinking to add cvars but what's the point..
			// Added handgun, smg (only main ones, rifle and heavy weapons are out) and revive
			...
			// pm->ps->weapon != WP_FG42 && // No scoping underwather tho
			// End
